          ...
          <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
            <div className="flex items-center">
              <button
                ...
                className="text-gray-500 focus:outline-none lg:hidden z-20"
              >
                <svg
                  className="w-6 h-6"
                  viewBox="0 0 24 24"
            ...
            <div className="flex items-center">
              ...
              <div className="relative">
                ...
                <div className="hidden z-50 absolute right-0 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl">
                  <button className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">
                    Logout
                  </button>
                </div>
              </div>
