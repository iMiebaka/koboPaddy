export default function BankIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      height="25px"
        ...
        <g>
          ...
          <g>
            ...
            <rect
              ...
              height="29"
            ></rect>{" "}
            <rect x="24" y="25" fill="#B4CCB9" width="4" height="29"></rect>{" "}
            <rect x="36" y="25" fill="#B4CCB9" width="4" height="29"></rect>{" "}
            <rect x="12" y="25" fill="#B4CCB9" width="4" height="29"></rect>{" "}
          </g>{" "}
          <g>
            {" "}
            <path
          ...
          <path
            fill="#F9EBB2"
            d="M4,23h56c0.893,0,1.684-0.601,1.926-1.461c0.24-0.86-0.125-1.785-0.889-2.248l-28-17 C32.725,2.1,32.365,2,32,2c-0.367,0-0.725,0.1-1.037,0.29L2.961,19.291c-0.764,0.463-1.129,1.388-0.888,2.247 C2.315,22.399,3.107,23,4,23z"
          ></path>{" "}
          <g>
            {" "}
            <path
          ...
          <circle fill="#F76D57" cx="32" cy="14" r="3"></circle>{" "}
        </g>{" "}
      </g>
    </svg>
  );
